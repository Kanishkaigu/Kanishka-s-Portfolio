...
export function Hero() {
    ...
    return (
        <section id="home" className="relative min-h-fit md:min-h-screen flex items-center justify-center overflow-hidden pt-12 pb-4 md:py-12">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-4 md:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
                    ...
                    >
                        <div className="space-y-4">
                            <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight" style={{ color: '#B09E80' }}>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            ...
                            >
                                <Eye className="mr-2 h-5 w-5" /> Resume
                            </a>
                        </div>
                    </motion.div>
